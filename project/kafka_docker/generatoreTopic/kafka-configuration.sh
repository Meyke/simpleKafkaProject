...
$KAFKA_HOME/bin/kafka-topics.sh --create --zookeeper 10.11.1.71:2181 --replication-factor 1 --partitions 2 --topic topic1

$KAFKA_HOME/bin/kafka-topics.sh --create --zookeeper 10.11.1.71:2181 --replication-factor 1 --partitions 1 --topic topic2
